...
const CommonQuestions = forwardRef(({ questions }, ref) => {
  ...
  return (
    <div ref={containerRef} className="border border-gray-200 rounded-xl overflow-hidden mt-4">
      <button
        type="button"
            ...
            return (
              <div key={i}>
                ...
                >
                  ...
                  <svg className={`flex-shrink-0 mt-0.5 w-4 h-4 text-gray-400 transition-transform duration-200 ${isOpen ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19 9l-7 7-7-7" />
                  </svg>
                </button>
                {isOpen && (
