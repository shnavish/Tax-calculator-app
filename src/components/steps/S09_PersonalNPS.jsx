        ...
        <div>
          ...
          <div className="flex gap-3 mb-3">
            <button
              ...
              className={`flex-1 py-2.5 px-4 rounded-xl border-2 font-semibold transition-colors ${data.hasPersonalNPS === true ? 'border-indigo-600 bg-indigo-900/30 text-indigo-400' : 'border-slate-700 bg-slate-900 text-slate-300 hover:border-gray-300 hover:bg-slate-800'}`}
            >
              Yes
            </button>
            <button
              onClick={() => { update({ hasPersonalNPS: false, personalNPS: '' }); setErrors({}) }}
              className={`flex-1 py-2.5 px-4 rounded-xl border-2 font-semibold transition-colors ${data.hasPersonalNPS === false ? 'border-indigo-600 bg-indigo-900/30 text-indigo-400' : 'border-slate-700 bg-slate-900 text-slate-300 hover:border-gray-300 hover:bg-slate-800'}`}
            >
              No
            </button>
          </div>
        ...
        {data.hasPersonalNPS && (
          <div className="bg-indigo-50/50 border border-indigo-800 rounded-xl p-4 reveal space-y-4">
            ...
            <div className="bg-green-900/30 border border-green-200 rounded-lg p-3">
              <p className="text-xs font-semibold text-green-400 mb-0.5">Extra ₹50,000 Deduction</p>
